    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active"><a href="{{ url('/ad') }}"><i class="fa fa-list-ul"></i> <span>Menu</span></a></li>
                ...
                <li ><a href="{{ route('admin.commands') }}"><i class="fa fa-pie-chart"></i> <span>Charts</span></a></li>
